...
test("documents every vertical slice API",()=>{for(const path of ["/session","/setup","/hcm","/performance","/payroll","/workforce","/dashboard","/management-reports","/integrity"])assert.ok(spec.paths[path],path)});
